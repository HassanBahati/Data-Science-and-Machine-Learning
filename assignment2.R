...
Assignment2_dataset <- read_excel("E:/Documents/Personal Learning/Data Science/Assignments/Assignment 2/Assignment2_dataset.xlsx")
...
ggplot(data = Assignment2_New, mapping = aes(x = Price)) +
  geom_freqpoly(mapping = aes(color = Perception), binwidth = 500)
